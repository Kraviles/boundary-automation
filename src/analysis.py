...
def run_full_analysis(
    iso_path='data/Valid country names and ISO codes - Sheet1.csv',
    completed_path='data/geoBoundaries_metadata.csv',
    missing_path='data/missing_layers.csv',
...
def fetch_github_issues():
    ...
    '''
    try:
        response = requests.get("https://api.github.com/repos/wmgeolab/geoBoundaries/issues")
        response.raise_for_status()
